/**
 * Exports data to an Excel file with formatted sheet (Lazy-loaded xlsx)
 * @param {Array<object>} data - Array of row objects
 * @param {string} fileName - File name without extension
 * @param {string} sheetName - Sheet name
 */
export const exportToExcel = async (data, fileName = 'bao-cao', sheetName = 'DuLieu') => {
  ...
  try {
    ...
    alert('Không thể tải module xuất file Excel. Vui lòng thử lại.');
  }
};
